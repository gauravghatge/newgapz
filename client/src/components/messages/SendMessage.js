          ...
          <div className="card card-signin my-5">
            <div className="card-body">
              <h2 className="card-title text-center">
                Say Something Amazing to{" "}
                <span id="usersendmsg" style={{ color: "red" }}>{username}</span>
              </h2>
		    ...
		    id="msgfieldsendmsg"
                ...
                <p style={{ fontSize: "18px" }}>
                  <span id="remsendmsg" style={{ color: "red" }}>{maxChars - charCounts}</span>{" "}
                  characters remaining
                </p>
                <hr className="mb-2" />
                <input
		  id="sendbuttonsendmsg"
                  type="submit"
