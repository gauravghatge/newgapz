    ...
    <section className="jumbotron p-10">
      <div className="d-flex flex-column container">
        ...
        <div className="d-flex justify-content-center mt-4">
          {userAuth ? (
            <Link to="/Profile" className="btn btn-primary px-3" id="myprofhome">
              Profile
            </Link>
          ) : (
            <Fragment>
              {" "}
              <Link to="/login" className="btn btn-primary mx-2 px-3" id="myloginhome">
                Login
              </Link>
              <Link to="/register" className="btn btn-primary mx-2 px-3" id="myregisterhome">
                Register
              </Link>
            </Fragment>
          )}
